...
| Interfering iso-field contours | Delivered historical reference; current regulatory iso-field not claimed | Red dash-dot E(50,10) cochannel/first-adjacent envelopes reproduce the threshold arithmetic from revoked FM Resolution 67/1998 and TV Resolution 398/2005, retain source/ruleset provenance, and set `regulatory = false`. Current digital-TV evidence remains the separate P.526-15 Deygout-Assis boundary D/U workflow. | Strict FM P.526/Assis, area/grid D/U, normalized reference-station patterns, independent goldens, and any justified current-regulation iso-field product remain open. |
